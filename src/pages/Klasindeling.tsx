...
export default function Klasindeling() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-100 via-purple-50 to-blue-100 p-8 print:bg-white print:p-0">
        ...
        {toonResultaat && (
          <>
            <div className="text-center mb-6">
              <div className="max-w-xl mx-auto mb-4 flex flex-col sm:flex-row items-center sm:justify-between gap-3 print:hidden">
